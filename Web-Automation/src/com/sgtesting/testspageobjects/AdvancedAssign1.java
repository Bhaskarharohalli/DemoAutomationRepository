...
public class AdvancedAssign1 {
	...
	private static void createUser1() {
		try {
			...
			Thread.sleep(2000);
			oPage.getAddUserFirstName().sendKeys("bhaskar1");
			oPage.getAddUserLastName().sendKeys("demo1");
			oPage.getAddUserEmail().sendKeys("bha1@gmail.com");
	...
	private static void createUser2() {
		try {
			...
			oPage.getCreateUserAddButton().click();
			Thread.sleep(2000);
			oPage.getAddUserFirstName().sendKeys("bhaskar2");
			oPage.getAddUserLastName().sendKeys("demo2");
			oPage.getAddUserEmail().sendKeys("bha2@gmail.com");
	...
	private static void createUser3() {
		try {
			...
			oPage.getCreateUserAddButton().click();
			Thread.sleep(2000);
			oPage.getAddUserFirstName().sendKeys("bhaskar3");
			oPage.getAddUserLastName().sendKeys("demo3");
			oPage.getAddUserEmail().sendKeys("bha3@gmail.com");
	...
	private static void modifyUserPassword() {
		try {
			...
			Thread.sleep(3000);
			oPage.getAddUserPassword().sendKeys("user1newpwd");
			Thread.sleep(3000);
			oPage.getAddUserRetypePassword().sendKeys("user1newpwd");
			Thread.sleep(3000);
			oPage.getCreateUserCreateButton().click();
			Thread.sleep(3000);
			...
			Thread.sleep(3000);
			oPage.getAddUserPassword().sendKeys("user2newpwd");
			Thread.sleep(3000);
			oPage.getAddUserRetypePassword().sendKeys("user2newpwd");
			Thread.sleep(3000);
			...
			Thread.sleep(3000);
			oPage.getAddUserPassword().sendKeys("user3newpwd");
			Thread.sleep(3000);
			oPage.getAddUserRetypePassword().sendKeys("user3newpwd");
			Thread.sleep(3000);
			oPage.getCreateUserCreateButton().click();
			Thread.sleep(3000);
	...
	private static void loginAsUser11() {
		try {
			oPage.getUserName().sendKeys("User1");
			oPage.getPassword().sendKeys("user1newpwd");
			oPage.getLoginButton().click();
			// Thread.sleep(1000);
			oPage.getXploreActimeIcon().click();
			Thread.sleep(2000);
	...
	private static void loginAsUser21() {
		try {
			oPage.getUserName().sendKeys("User2");
			oPage.getPassword().sendKeys("user2newpwd");
			oPage.getLoginButton().click();
			Thread.sleep(2000);
			oPage.getXploreActimeIcon().click();
			Thread.sleep(2000);
	...
	private static void loginAsUser31() {
		try {
			oPage.getUserName().sendKeys("User3");
			oPage.getPassword().sendKeys("user3newpwd");
			oPage.getLoginButton().click();
			Thread.sleep(2000);
			oPage.getXploreActimeIcon().click();
			Thread.sleep(2000);
